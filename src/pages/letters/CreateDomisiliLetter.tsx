...
const CreateDomisiliLetter: React.FC<{ editData?: Letter; isEditMode?: boolean }> = ({ editData, isEditMode }) => {
  ...
  return (
    <div className="max-w-3xl mx-auto py-8">
      <h1 className="text-2xl font-bold mb-4 text-center text-teal-800">Surat Keterangan Domisili</h1>
      <div className="mb-4">
        <input
          type="text"
      ...
      <form className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
        ...
        <input name="lamaTinggal" value={form.lamaTinggal} onChange={handleChange} placeholder="Lama Tinggal (tahun)" className="input" />
      </form>
      ...
      <div id="domisili-preview" className="bg-white p-8 border shadow max-w-[800px] mx-auto">
        <div className="container" style={{ width: '210mm', minHeight: '297mm', padding: '1cm', margin: 'auto', background: 'white', boxSizing: 'border-box' }}>
          ...
          <h2 style={{ textAlign: 'center', textDecoration: 'underline', fontSize: '11pt' }}>SURAT KETERANGAN DOMISILI TEMPAT TINGGAL</h2>
          ...
          <div className="content" style={{ marginTop: 30 }}>
            ...
            <table style={{ marginLeft: 20 }}>
              <tbody>
                ...
                <tr><td>3. Bin/Binti</td><td>:</td><td></td></tr>
                <tr><td>4. Tempat/Tgl Lahir</td><td>:</td><td>{form.tempatLahir}, {form.tanggalLahir && new Date(form.tanggalLahir).toLocaleDateString('id-ID')}</td></tr>
                <tr><td>5. Agama</td><td>:</td><td>{form.agama}</td></tr>
                <tr><td>6. Warganegara</td><td>:</td><td>Indonesia</td></tr>
            ...
            <p>Berdasakan Surat Keterangan dari Ketua Rukun Tetangga Nomor Tanggal, bahwa yang bersangkutan benar penduduk Desa Kedungwringin Kecamatan Patikreja Kabupaten Banyumas yang beralamat pada alamat tersebut diatas, surat ini dibuat untuk keperluan administrasi.</p>
