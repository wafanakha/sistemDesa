    ...
    <div className="max-w-3xl mx-auto py-8">
      ...
      <div id="domisili-preview" className="bg-white p-8 border shadow max-w-[800px] mx-auto">
        ...
        <div className="text-center mt-4 mb-2">
          <div className="font-bold underline text-lg">SURAT KETERANGAN DOMISILI</div>
        ...
        <table className="mb-2">
          <tbody>
            ...
            <tr><td>Lama Tinggal</td><td className="px-2">:</td><td>{form.lamaTinggal} tahun</td></tr>
          </tbody>
        </table>
        <div className="mb-2">Adalah benar berdomisili di Desa Bumi Makmur dan surat ini dibuat untuk keperluan administrasi.</div>
