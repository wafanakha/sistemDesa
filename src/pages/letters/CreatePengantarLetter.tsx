...
const CreatePengantarLetter: React.FC<{ editData?: Letter; isEditMode?: boolean }> = ({ editData, isEditMode }) => {
  ...
  const handleExportPDF = () => {
    ...
    doc.setFont('helvetica', 'normal');
    doc.setFontSize(10);
    doc.text('Nomor: 123/SKP/[BULAN]/[TAHUN]', pageWidth / 2, y, { align: 'center' });
    y += 8;
    // Pembuka
    ...
    y += 2;
    doc.text(`Adalah benar warga Desa Kedungwringin dan surat ini dibuat untuk keperluan: ${form.keperluan || '...'} `, 15, y, { maxWidth: pageWidth - 30 });
    y += 10;
    doc.text('Demikian surat pengantar ini dibuat untuk dapat dipergunakan sebagaimana mestinya.', 15, y, { maxWidth: pageWidth - 30 });
    y += 16;
    // TTD
    const ttdY = y;
  ...
  return (
    <div className="max-w-3xl mx-auto py-8">
      ...
      <div id="pengantar-preview" className="bg-white p-8 border shadow max-w-[800px] mx-auto hidden">
        ...
        <div className="mb-2">Adalah benar warga Desa Bumi Makmur dan surat ini dibuat untuk keperluan: <span className="font-semibold">{form.keperluan}</span></div>
        <div className="mb-2">Demikian surat pengantar ini dibuat untuk dapat dipergunakan sebagaimana mestinya.</div>
