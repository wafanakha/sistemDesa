...
const CreateKeramaianLetter: React.FC<{
  ...
  const handleExportPDF = () => {
    ...
    doc.setFontSize(13);
    doc.text("PEMERINTAHAN DESA KEDUNGWRINGIN", pageWidth / 2 + 10, y + 6, {
      align: "center",
    });
    doc.text(
    ...
    doc.text("SEKERTARIAT DESA", pageWidth / 2 + 10, y + 18, {
      align: "center",
    });
    doc.setFontSize(10);
    doc.text(
    ...
    doc.text("Telp. (0281) 638395", pageWidth / 2 + 10, y + 29, {
      align: "center",
    });
    y += 32;
    ...
    doc.setFontSize(10);
    doc.setFont("helvetica", "normal");
    doc.text("Nomor: 123/SKTM/[BULAN]/[TAHUN]", pageWidth / 2, y, {
      align: "center",
    });
    y += 10;
    // Paragraf pembuka
